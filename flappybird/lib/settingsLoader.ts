 ...
 * Works offline by importing public/data/game-settings.json
 */

import gameSettingsData from "@/public/data/game-settings.json";
...
export async function loadGameSettings(): Promise<GameSettings> {
  try {
    const loaded = gameSettingsData as Partial<GameSettings>;
